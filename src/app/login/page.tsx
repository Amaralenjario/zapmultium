    ...
    <div className="flex min-h-screen items-center justify-center px-4 bg-bg">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-card border border-bd bg-surface p-8 shadow-pop">
          <h2 className="text-xl font-bold tracking-[-0.02em] text-tx mb-6">Entrar</h2>
          <LoginForm />
          <p className="mt-6 text-center text-sm text-tx2">
            Não tem conta?{" "}
            <Link href="/register" className="text-accent hover:text-accent2 font-bold transition-colors">
              Criar conta
            </Link>
          </p>
        </div>
