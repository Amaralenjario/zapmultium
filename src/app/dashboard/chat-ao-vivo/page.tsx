...
export default function ChatPageClient() {
  ...
  return (
    <div className="-m-8 flex h-[calc(100vh-4rem)]">
      <div className="w-[350px] 2xl:w-[400px] flex-shrink-0 border-r border-gray-200 dark:border-[#222d34]">
        <ConversationList
        ...
        {selectedConversation ? (
          ...
          <div className="flex-1 flex items-center justify-center bg-[#efeae2] dark:bg-[#0b141a]">
            <div className="text-center px-8">
              <svg className="w-20 h-20 mx-auto mb-3 text-[#25d366] opacity-40" fill="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-light text-gray-500 dark:text-gray-400 mb-1">ZapMultium</h3>
