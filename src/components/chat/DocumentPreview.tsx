  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold text-current truncate">{name}</p>
      ...
      <div className="w-8 h-8 rounded-full opacity-70 hover:opacity-100 flex items-center justify-center flex-shrink-0">
